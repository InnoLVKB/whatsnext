...
function Test() {
  ...
  return (
      <>
        <button onClick={handleDrag} className="bg-slate-200 border-2">{draggableHandler ? 'Turn off drag' : 'Turn on drag'}</button>
        <Draggable disabled={!draggableHandler}>
          <Resizable
            ...
            // maxWidth={380}
            // maxHeight={380}
            className="border-2 border-black">RESIZE me PLease
          </Resizable>
        </Draggable>
      </>
  )
